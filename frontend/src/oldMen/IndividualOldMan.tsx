         ...
         <div className="lg:gap-xl-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
            <div className="mb-12 lg:mb-0">
               <img
                  ...
                  src="https://2.bp.blogspot.com/-kLpffBOeAIs/WZ4Uh7AyXAI/AAAAAAAAAmw/Ik6-Vh-udsopU2bw5RFLQtsODMPrhFEbQCLcBGAs/s1600/9067997-Un-anciano-sentado-en-una-silla-en-su-casa-closeup-con-espacio-de-copia-Foto-de-archivo.jpg"
                  alt="avatar"
               />
