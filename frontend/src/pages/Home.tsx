...
import fondoAbuelos from '../assets/img/banner.png'
...
export default function Home() {
  return (
    <div className="bg-gray-100">
      ...
      <main>
      <section 
  className="overflow-auto relative text-white text-center flex items-center justify-center bg-no-repeat bg-cover bg-center shadow-2xl"
  style={{ 
...
>
  <div className="bg-sky-900 p-6 sm:p-12 rounded-xl shadow-lg max-w-full sm:max-w-xl md:max-w-3xl lg:max-w-4xl xl:max-w-6xl mx-auto"> {/* Ancho máximo y padding ajustados */}
...
<section className="py-12 px-6 mx-auto max-w-7xl">
  ...
  <div className="flex flex-col md:flex-row gap-8">
    <div className="text-sky-900 bg-white shadow rounded-lg overflow-hidden flex flex-col items-center w-full md:w-1/3 transform transition duration-300 hover:scale-105 hover:shadow-2xl">
    ...
    <div className="bg-white shadow rounded-lg overflow-hidden flex flex-col items-center w-full md:w-1/3 transform transition duration-300 hover:scale-105 hover:shadow-2xl">
...
<section className="py-12 px-6 bg-gradient-to-b from-sky-100 via-sky-200 to-sky-900/50 relative text-white">
  ...
  <div className="flex justify-center gap-8 mt-6 flex-col md:flex-row">
    <div className="flex flex-col items-center w-full md:w-1/5 transform transition duration-300 hover:scale-105 hover:shadow-2xl mb-8 md:mb-0">
    ...
    <div className="flex flex-col items-center w-full md:w-1/5 transform transition duration-300 hover:scale-105 hover:shadow-2xl">
      <div className="h-64 w-full rounded-lg overflow-hidden">
